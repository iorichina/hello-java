    ...
    define('widgets/image',[
        ...
        return Uploader.register({
            ...
            compressImage: function( file ) {
                console.log('compressImage',this.options.compress, this.options.resize)
    ...
    define('widgets/queue',[
        ...
        return Uploader.register({
            ...
            _addFile: function( file ) {
                ...
                console.log('_addFile', file, !file, file.size, me.accept, file.name)
                if ( !file || !file.size || file.size < 6 || (me.accept &&
            ...
            addFiles: function( files ) {
                console.log('addFiles', files, !files.length)
                var me = this;
